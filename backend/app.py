...
model = joblib.load("SuperKart_XGBModel.joblib")
...
def predict_sales():
    ...
    sample = {'Product_Weight': data['Product_Weight'],
...
def predict_sales_batch():
    ...
    # Drop columns from the list that were not used for modeling
    input_data = input_data.drop(columns=['Store_Size', 
